...
def seed_defaults (app =None ):
    ...
    try :
        defaults =[
        ('credit_card','Credit Card','bg-blue-600 text-white'),
        ('debit_card','Debit Card','bg-sky-600 text-white'),
        ('upi','UPI','bg-emerald-600 text-white'),
        ('bank_transfer','Bank Transfer','bg-indigo-600 text-white'),
        ('netbanking','Netbanking','bg-violet-600 text-white'),
        ('wallet','Wallet','bg-amber-500 text-gray-900'),
        ('cash','Cash','bg-lime-600 text-gray-900'),
        ('other','Other','bg-gray-600 text-white'),
        ]
        for key ,label ,color in defaults :
            ...
            if not existing :
                ...
                created +=1 
        tag_defaults =[
        ('rent','Rent','bg-indigo-700 text-white'),
        ('groceries','Groceries','bg-emerald-600 text-white'),
        ('internet','Internet','bg-violet-600 text-white'),
        ('electricity','Electricity','bg-yellow-600 text-gray-900'),
        ('other','Other','bg-gray-600 text-white'),
        ]
